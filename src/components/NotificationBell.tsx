...
// import { Badge } from './ui/Badge'; // Unused - commented for future use

export const NotificationBell: React.FC = () => {
  const [isOpen, setIsOpen] = useState(false);
  const dropdownRef = useRef<HTMLDivElement>(null);
  const { user } = useAuthStore();
  const { markAsRead, markAllAsRead, getNotificationsForRole, getUnreadCount } = useNotificationStore();
  ...
  // Commented for future use - notification color coding
